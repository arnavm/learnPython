# Write a program that takes in a (space-delimited) list of names and reports to the user, "You entered these names:" followed by the names (one per line) in alphabetical order. The last line should tell the user how many names they entered, i.e. "You entered ____ names."
