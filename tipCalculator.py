# Write a program that takes as input the cost of a meal. 
# Then, tell the user what 15% tip would be ("Fifteen percent tip for this meal is ____") 
# and what the total cost will be ("This meal costs ___ in total").
